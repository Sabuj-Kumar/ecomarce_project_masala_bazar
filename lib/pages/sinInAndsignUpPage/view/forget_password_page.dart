          ...
          child: Column(
            children: [
              const ImageAndText(
                ...
                text2: "Enter your email address to request a password reset.",
              ),
        ...
        ElevatedButton(
            onPressed: () {
              ...
              String s = _emailOrMobile.text;
                if(s.length == 11) {
                  Navigator.pushNamed(
                      context, "resetPassPage/$s");
                }else{
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Number Must Be 11 Digits.")));
                }
            },
